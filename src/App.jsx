    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/coding-guides" element={<Tutorials />} />
          <Route path="/tutorials" element={<Navigate to="/coding-guides" replace />} />
          <Route path="/programming-tutorials" element={<Navigate to="/coding-guides" replace />} />
