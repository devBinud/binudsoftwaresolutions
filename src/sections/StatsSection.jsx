...
const StatsSection = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-[#fdfbfe] to-[#faf7fc] py-6 md:py-10 overflow-hidden">
      <motion.div
      ...
      >
        ...
        >
          ...
          <div className="md:col-span-6 flex justify-start md:justify-end select-none pointer-events-none md:absolute md:right-12 md:top-1/2 md:-translate-y-1/2 overflow-hidden w-full md:w-auto h-fit">
            <span className="text-[#005eb8]/[0.05] font-black text-[11vw] md:text-[5rem] xl:text-[5.8rem] uppercase tracking-[0.08em] whitespace-nowrap leading-none transition-transform duration-700 group-hover:scale-[1.03] group-hover:text-[#005eb8]/[0.09] font-sans">
              Globally completed
            </span>
          </div>
        </motion.div>
