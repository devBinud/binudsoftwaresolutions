...
const LatestBlogsSection = () => {
  ...
  return (
    <section className="relative py-20 md:py-28 bg-[#f8fafc] overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#005eb8]/4 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14 text-left">
          <div>
            ...
            <p className="text-slate-400 text-sm sm:text-base font-semibold leading-relaxed font-sans mt-2 max-w-xl">
              Stay updated with tech insights, software architecture trends, and mobile development best practices.
            </p>
          </div>
          ...
          >
            <div className="w-12 h-12 rounded-full border border-[#191919]/30 flex items-center justify-center text-[#191919] group-hover:bg-[#005eb8] group-hover:text-white group-hover:border-[#005eb8] group-hover:scale-105 transition-all duration-300 shrink-0">
        ...
        >
          {latestPosts.map((post) => (
            <motion.article
              ...
              className="bg-white border border-slate-200/90 rounded-none overflow-hidden shadow-sm hover:shadow-md hover:border-[#005eb8] transition-all duration-300 flex flex-col h-full group"
            >
              {/* Card Image Banner */}
              <div className="relative w-full aspect-[16/10] overflow-hidden bg-slate-100">
                ...
                <div className="absolute top-3 left-3">
                  <span className="inline-block px-2.5 py-1 rounded-none text-[9px] font-extrabold uppercase tracking-wider bg-[#005eb8] text-white shadow-sm">
                    {post.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex flex-col flex-grow text-left">
                ...
                <h3 className="text-lg font-black text-[#191919] group-hover:text-[#005eb8] leading-snug tracking-tight mb-2.5 transition-colors duration-300 line-clamp-2">
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <Link
                    to={`/blog/${post.id}`}
                    className="text-xs font-extrabold text-[#005eb8] group-hover:translate-x-1 transition-transform duration-300 inline-flex items-center gap-1"
                  >
